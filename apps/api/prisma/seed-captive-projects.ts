...
import { PrismaClient, ProjectPhaseCode, TaskStatus } from '@prisma/client';
...
const BASE_TASKS: SeedTask[] = [
  {
    phaseCode: ProjectPhaseCode.QUALIFICATION_CADRAGE,
  ...
  {
    phaseCode: ProjectPhaseCode.FORMALISATION_ENGAGEMENT,
  ...
  {
    phaseCode: ProjectPhaseCode.ANALYSE_STRUCTURATION,
  ...
  {
    phaseCode: ProjectPhaseCode.PRESENTATION_AJUSTEMENTS,
  ...
  {
    phaseCode: ProjectPhaseCode.MISE_EN_OEUVRE,
  ...
  {
    phaseCode: ProjectPhaseCode.CLOTURE_SUIVI,
...
const CAPTIVE_VARIANTS: Record<string, SeedTask[]> = {
  CAPTIVE_SIMPLE: [
    {
      phaseCode: ProjectPhaseCode.ANALYSE_STRUCTURATION,
