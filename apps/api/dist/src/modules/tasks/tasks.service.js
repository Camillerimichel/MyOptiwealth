        ...
        const task = await this.prisma.$transaction(async (tx) => {
            ...
            return tx.task.create({
                data: {
                    ...
                    startsAfterTaskId: dto.startsAfterTaskId,
                    planningStartDate: dto.planningStartDate,
                    plannedDurationDays: dto.plannedDurationDays,
                    overrunDays: dto.overrunDays ?? 0,
                    planningEndDate: dto.planningEndDate,
