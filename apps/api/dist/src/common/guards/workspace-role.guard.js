...
const prisma_service_1 = require("../../modules/prisma.service");
...
let WorkspaceRoleGuard = class WorkspaceRoleGuard {
    ...
    async canActivate(context) {
        const requiredRoles = this.reflector.getAllAndOverride(workspace_roles_decorator_1.WORKSPACE_ROLES_KEY, [context.getHandler(), context.getClass()]);
        ...
        if (!userId || !workspaceId) {
            throw new common_1.UnauthorizedException('Missing authentication context');
        }
